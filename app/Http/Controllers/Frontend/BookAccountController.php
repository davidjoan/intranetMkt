...
class BookAccountController extends Controller {
    ...
    protected $bookAccount;
    private $responseFactory;

    public function __construct(BookAccount $bookAccount, ResponseFactory $responseFactory)
    {
	...
	{
        $bookAccounts = $this->bookAccount->all();
        return $this->responseFactory->json($bookAccounts);
	}
